...
function parseMenu(menu) {
  ...
  var toggles = menu.querySelectorAll("button[toggle]");
  var menus = menu.querySelectorAll("nav ul");
  var topmenu = menu.querySelectorAll("nav > ul"); // Initial parse for items.

  items.forEach(function (item) {
    item.classList.add("".concat(elName, "__menuItem"));

    if (item.querySelector("ul")) {
      item.classList.add("".concat(elName, "__menuItem--parent"));
    }
  ...
  prototype: Object.create(HTMLElement.prototype, {
    createdCallback: {
      value: function value() {
        ...
        var parsed = parseMenu(getElements(this).menu);
